...
const validate = {
  ...
  borderObjectColor: value => invariant(
    'color' in value,
  ...
  textCaptionStyles: value => {
    ...
    invariant(
      ...
      'text caption', JSON.stringify(value), `required options are 'fontFamily' and 'fontSize'`,
    ...
    invariant(
      ...
      'text caption', JSON.stringify(value), `options are invalid`,
      '/image_transformations#adding_text_captions',
    )
  },
  defaultImage: value => invariant(
    ...
    case 'underlay':
      if (typeof value === 'object') {
        ...
        if (!stringStyle) {
          ...
          stringStyle = [
            encodeURIComponent(value.fontFamily), value.fontSize, value.fontWeight, value.fontStyle,
            value.textDecoration, value.textAlign, value.stroke,
